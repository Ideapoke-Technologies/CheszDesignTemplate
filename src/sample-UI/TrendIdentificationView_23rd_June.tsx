...
const SIGNALS: Signal[] = [
  {
    ...
    description:
      "Sustained cross-industry shift toward edge computing and embedded AI within European IIoT platforms. EU R&D funding exceeding €150M since 2021, formal standards (AIOTI, ARTEMIS-IA) and patent portfolios emphasize edge-native orchestration.",
    timeRange: "2021–2026",
    geography: "Europe",
    confidence: "High",
    strength: "Strong",
    directionalImplication:
      "Consolidates edge AI as the default architecture for IIoT innovation in Europe; fosters regulatory-compliant, energy-optimized platforms.",
  },
  {
    id: "SIG-02",
    ...
    description:
      "Binding European legislation (Interoperable Europe Act, Cybersecurity Act, NIS2, Data Act, AI Act) enforces open, secure, and interoperable IIoT platforms. OPC UA, MQTT, Gaia-X, IDSA mandates transform platform competition.",
    timeRange: "2023–2026",
    geography: "Europe",
    confidence: "High",
    strength: "Strong",
    directionalImplication:
      "Accelerates market shift toward open, interoperable, compliance-ready IIoT platforms; enforces cross-sector data portability.",
  },
  {
    id: "SIG-03",
    title:
      "Enterprise IIoT Adoption Accelerates via Compliance and Digital Investment",
    category: "Enterprise Adoption/Business Model",
    description:
      "European manufacturers report accelerated IIoT adoption driven by EU Green Deal, CSRD compliance, sustainability goals, and government funding (Horizon Europe, TEFs). 13.5% SME adoption by 2024 with CAGR over 23% (2024–2033).",
    timeRange: "2022–2026",
    geography: "Europe",
    confidence: "High",
    strength: "Strong",
    directionalImplication:
      "Sustained double-digit growth, platform specialization, increased compliance requirements; higher entry hurdles for suppliers.",
  },
  {
    id: "SIG-04",
    ...
    description:
      "IIoT platforms evolving from siloed architectures to distributed, federated, sovereignty-preserving models. Adoption of Gaia-X, IDSA, OPC UA evidenced in technical roadmaps and patent filings.",
    timeRange: "2016–2026",
    geography: "Europe",
    confidence: "High",
    strength: "Strong",
    directionalImplication:
      "Elevates data sovereignty as a competitive differentiator; forces global vendors to align with European technical and legal standards.",
  },
  {
    id: "SIG-05",
    ...
    description:
      "Despite overall growth, notable disparities in IIoT adoption among SMEs in Eastern and Southern Europe due to infrastructure constraints, limited integrator capacity, and workforce skills shortages.",
    timeRange: "2024–2026",
    geography: "Europe (notably Central/Eastern and Southern EU)",
    confidence: "Moderate",
    strength: "Weak",
    directionalImplication:
      "Implies heterogeneous digital transformation pace; unclear temporal persistence or reversibility.",
  },
];
...
const TRENDS: Trend[] = [
  {
    ...
    definition:
      "Structural migration of computation, analytics, and orchestrated automation to the industrial edge. Edge-native AI and distributed architectures are becoming foundational to European IIoT ecosystems, supplanting legacy monolithic cloud stacks.",
    coreEvidence: [
  ...
  },
  {
    ...
    domain: "Industrial IoT Platforms",
    definition:
      "Structural ecosystem transformation catalyzed by regulatory mandates (EU Data Act, AI Act) and standards alliances (Gaia-X, IDSA, OPC-UA) driving migration from proprietary silos toward open, federated, compliance-driven architectures.",
    coreEvidence: [
  ...
  },
  {
    ...
    domain: "Industrial IoT Platforms",
    definition:
      "Predictive, adaptive, and autonomy-enabling AI capabilities and digital twins are now baseline requirements in advanced industrial verticals, deeply integrated as systemic intelligence layers in manufacturing and infrastructure operations.",
    coreEvidence: [
  ...
  },
  {
    ...
    domain: "Industrial IoT Platforms",
    definition:
      "Compliance, governance, and trustworthy ecosystem management have shifted from niche differentiators to sector-wide competitive baselines, shaped by increasingly prescriptive EU regulatory environments requiring embedded transparency and auditability.",
    coreEvidence: [
  ...
  },
  {
    ...
    domain: "Industrial IoT Platforms",
    definition:
      "Structural asymmetry in IIoT adoption between advanced regions/large enterprises and SMEs/lagging regions constitutes a persistent constraint on ecosystem-wide convergence, creating digital divide risks in Europe's industrial transformation.",
    coreEvidence: [
...
const EMERGING_OPPORTUNITIES = [
  {
    title: "Federated Industrial Data Spaces",
    desc: "Collaborative analytics, cross-border compliance, and supply chain transparency across value chains and sectors.",
  },
  {
    title: "Edge AI & Digital Twin Orchestration",
    desc: "Scalable orchestration within open, regulated industrial platforms enabling predictive sustainability management.",
  },
  {
    title: "Sovereign AI Infrastructure",
    desc: "Trusted industrial cloud/edge ecosystems building on Gaia-X principles for European digital sovereignty.",
  },
  {
    title: "Compliance-as-a-Service",
    desc: "Modular interoperability enablement for SMEs and regional clusters who lack in-house compliance capacity.",
  },
  {
    title: "Circular Economy Applications",
    desc: "Sector-specific use cases for resource optimization, digital product passport compliance, and emissions traceability.",
  },
];
...
const CONFIDENCE_CRITERIA: string =
  "Confidence reflects how well a trend is backed by independent, consistent sources.\n\nHigh: multiple independent sources, including regulatory texts, market data, and observable deployments, all point in the same direction.\n\nModerate: partially supported, but with fewer sources, mixed signals, or unresolved gaps.\n\nLow: based on a single source or early-stage speculation.";

const CONFIDENCE_INTRO =
  "How well the trend is backed by independent, consistent sources:";
const CONFIDENCE_ITEMS: TooltipItem[] = [
  {
    label: "High",
    swatch: "#10b981",
    desc: "Multiple independent sources, including regulatory texts, market data, and observable deployments, all point in the same direction.",
  },
  {
    label: "Moderate",
    swatch: "#f59e0b",
    desc: "Partially supported, with fewer sources, mixed signals, or unresolved gaps.",
  },
  {
    label: "Low",
    swatch: "#ef4444",
    desc: "Based on a single source or early-stage speculation.",
  },
];

const PRIORITY_INTRO =
  "Trends are ranked by composite strategic priority, based on:";
const PRIORITY_ITEMS: TooltipItem[] = [
  {
    num: 1,
    desc: "Strength and consistency of supporting data across independent sources",
  },
  { num: 2, desc: "Pace and direction of change" },
  {
    num: 3,
    desc: "Breadth of ecosystem impact across actors and value chains",
  },
  {
    num: 4,
    desc: "Urgency of strategic response required within the 2020–2030 window",
  },
];
...
const STAGE_DEFINITIONS: TooltipTableItem[] = [
  {
    label: "Emerging",
    swatch: STAGE_PALETTE["Emerging"].border,
    desc: "Early-stage shift; signals are emerging but adoption is not yet widespread.",
  },
  {
    label: "Accelerating",
    swatch: STAGE_PALETTE["Accelerating"].border,
    desc: "Rapid growth in adoption and investment; not yet mainstream.",
  },
  {
    label: "Mainstreaming",
    swatch: STAGE_PALETTE["Mainstreaming"].border,
    desc: "Becoming baseline among leading enterprises; shifting from differentiator to default.",
  },
  {
    label: "Mature",
    swatch: STAGE_PALETTE["Mature"].border,
    desc: "Widespread adoption; growth has stabilised.",
  },
  {
    label: "Plateauing",
    swatch: STAGE_PALETTE["Plateauing"].border,
    desc: "Broad adoption reached; trend approaching saturation.",
  },
  {
    label: "Fragmenting",
    swatch: STAGE_PALETTE["Fragmenting"].border,
    desc: "Splitting into competing, sometimes incompatible approaches.",
  },
  {
    label: "Declining",
    swatch: STAGE_PALETTE["Declining"].border,
    desc: "Losing relevance or displaced by newer approaches.",
  },
  {
    label: "Re-emerging",
    swatch: STAGE_PALETTE["Re-emerging"].border,
    desc: "Previously declining trend regaining traction under new conditions.",
  },
  {
    label: "Cyclical",
    swatch: STAGE_PALETTE["Cyclical"].border,
    desc: "Recurs in waves tied to investment or regulatory cycles.",
  },
];

const TREND_TYPE_INTRO =
  "Each trend is classified by the primary force driving the shift:";
const TREND_TYPE_DEFINITIONS: TooltipItem[] = [
  {
    label: "Technological",
    desc: "Shifts driven by new technical capabilities, architectures, or engineering approaches (e.g., edge AI, federated systems).",
  },
  {
    label: "Regulatory",
    desc: "Shifts driven by binding legislation, standards mandates, or compliance requirements.",
  },
  {
    label: "Enterprise Adoption",
    desc: "Shifts in how, and how quickly, organisations adopt, deploy, and scale a capability.",
  },
  {
    label: "Business Model",
    desc: "Shifts in how value is created, delivered, or captured across the ecosystem.",
  },
  {
    label: "Ecosystem/Platform",
    desc: "Shifts in how actors, platforms, and value chains are structured and interrelate.",
  },
];

const fullTrendType = (type: string): string => (type ? `${type} Trend` : "");

const SIGNAL_CATEGORY_DEFINITIONS: TooltipItem[] = [
  {
    label: "Technological",
    desc: "Driven by new technical capabilities, architectures, or engineering approaches, such as edge AI, federated systems, or embedded intelligence.",
  },
  {
    label: "Regulatory/Ecosystem",
    desc: "Driven by binding legislation, standards mandates, compliance requirements, or shifts in how platform actors and value chains are structured.",
  },
  {
    label: "Enterprise Adoption",
    desc: "Reflects shifts in how, and how quickly, organisations adopt, deploy, and scale a capability across their operations.",
  },
  {
    label: "Business Model",
    desc: "Reflects shifts in how value is created, delivered, or captured across the ecosystem.",
  },
  {
    label: "Ecosystem/Platform",
    desc: "Reflects shifts in how actors, platforms, and value chains are structured and interrelated.",
  },
  {
    label: "Talent/Workforce",
    desc: "Driven by availability of skills, labour dynamics, or changes in how people work with and around new technologies.",
  },
];
...
const InfoTooltip: FC<InfoTooltipProps> = ({
  ...
  return (
    <span
      ref={anchorRef}
      className={`relative inline-flex items-center${trigger ? "" : " ml-1"}`}
      ...
      {visible && coords && (
        ...
        >
          <div className="bg-white text-black text-[11px] leading-relaxed rounded-lg shadow-xl border border-slate-200 overflow-hidden">
            <div className="p-3">
              {title && (
                <div className="font-bold text-[12px] text-[#0f2644] mb-1.5">
                  {title}
                </div>
              )}
              {intro && (
                <div className="mb-2 text-black font-medium">{intro}</div>
              )}
              {tableItems ? (
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <span style={{ fontWeight: 600, color: "#0f2644" }}>
                              {it.label}
                            </span>
                          </span>
                        </td>
                  ...
                  {items.map((it, i) => (
                    <div key={i} className="py-1.5 first:pt-0 last:pb-0">
                      <p className="text-black m-0">
                        ...
                        {it.num != null && (
                          <span className="font-bold">{it.num}. </span>
                        )}
                        {it.label && (
...
function TrendMaturityLandscape({
  onGoTab,
  onOpenDrawer,
}: {
  onGoTab: (tab: string) => void;
  onOpenDrawer: (t: Trend) => void;
}) {
  const YEARS: number[] = [
  ...
  const trendPhases: Record<string, PhaseEntry[]> = {
    "TR-01": [
      { stage: "Emerging", years: [2020, 2021] },
      { stage: "Accelerating", years: [2022, 2023, 2024] },
      { stage: "Mainstreaming", years: [2025, 2026, 2027, 2028, 2029, 2030] },
    ],
    "TR-02": [
      { stage: "Emerging", years: [2020, 2021, 2022] },
      { stage: "Accelerating", years: [2023, 2024, 2025, 2026] },
      { stage: "Mainstreaming", years: [2027, 2028, 2029, 2030] },
    ],
    "TR-03": [
      { stage: "Accelerating", years: [2020, 2021, 2022, 2023] },
      {
        stage: "Mainstreaming",
    ...
    "TR-04": [
      { stage: "Emerging", years: [2020, 2021, 2022] },
      { stage: "Accelerating", years: [2023, 2024, 2025, 2026, 2027] },
      { stage: "Mainstreaming", years: [2028, 2029, 2030] },
    ],
    "TR-05": [
      {
        stage: "Plateauing",
        ...
        <div>
          <div className="flex items-center gap-1">
            <span className="text-[15px] font-bold text-[#0f2644]">
              Trend Maturity Landscape: European IIoT (2020–2030)
            </span>
          </div>
          <div className="text-[13px] text-slate-400 mt-0.5">
            Bars show lifecycle stage transitions ·{" "}
            <span className="text-orange-500 font-semibold">
              dashed line = 2026 current
            </span>{" "}
            · right column shows current stage
          </div>
        </div>
        <button
          onClick={() => onGoTab("evolution")}
        ...
        <div className="flex flex-1">
          {YEARS.map((y) => (
            <div key={y} className="flex-1 text-center">
              <span
                className={`text-[11px] font-semibold ${y === 2026 ? "text-orange-500" : "text-slate-400"}`}
              >
                {y}
              </span>
              {y === 2026 && (
                <div className="text-[9px] font-bold text-orange-500 leading-none">
                  now
                </div>
              )}
            </div>
        ...
        {TRENDS.map((t) => {
          ...
          return (
            <div key={t.id}>
              ...
              >
                <div className="w-4 h-4 rounded bg-[#0f2644] text-white text-[9px] font-black flex items-center justify-center flex-shrink-0">
                  {t.priorityRank}
                </div>
                <span className="text-[11px] font-semibold text-[#0f2644] leading-tight truncate group-hover:text-blue-700 transition-colors">
                  {t.name}
                </span>
                <svg
                  width="10"
                  ...
                  strokeWidth="2.5"
                  viewBox="0 0 24 24"
                  className="flex-shrink-0 opacity-0 group-hover:opacity-100 group-hover:stroke-blue-400 transition-all"
                >
              ...
              <div className="flex items-center">
                <div className="flex-1 relative h-7">
                  {phases.map((ph, pi) => {
                    ...
                    const c =
                      STAGE_PALETTE[ph.stage] || STAGE_PALETTE["Emerging"];
                    const isFirst = pi === 0;
                    ...
                    return (
                      ...
                      >
                        <span
                          className="text-[11px] font-semibold px-1 truncate"
                          style={{ color: c.text }}
                        >
                          {ph.stage}
                        </span>
                  ...
                  <div
                    ...
                    style={{
                      left: `${((2026 - 2020 + 0.5) / YEARS.length) * 100}%`,
                      width: 0,
                ...
                <div className="w-[108px] flex-shrink-0 pl-3">
                  <InfoTooltip
                    trigger={
                      <span
                        className={`text-[11px] font-bold px-1.5 py-0.5 rounded border cursor-help ${stageColor(t.stage)}`}
                      >
                        {t.stage}
                      </span>
                    }
                    title="Lifecycle Stages"
                    tableItems={STAGE_DEFINITIONS}
                    width={480}
                    align="right"
                  />
                </div>
    ...
    <div className="space-y-6">
        ...
        {[
          {
            ...
            sub: "4 strong · 1 weak signal",
            tab: "signals",
            tooltip:
              "Signals are discrete, observable market or technology events detected across structured research, regulatory databases, and industry publications. Each signal is assessed for strength (Strong/Weak) and directional implication.",
            align: "left",
            cardIcon: (
              <svg
                width="14"
          ...
          },
          {
            ...
            value: TRENDS.length,
            sub: "Technological to Ecosystem",
            tab: "trends",
            tooltip:
              "Trends are sustained, directional shifts derived from clustering and synthesising multiple signals. Each trend is profiled by type (Technological, Regulatory, etc.), lifecycle stage, confidence level, and strategic implications.",
            align: "left",
            cardIcon: (
              <svg
                width="14"
          ...
          {
            label: "High Confidence Trends",
            value: highConf,
            sub: "Backed by multiple sources",
            tab: "trends",
            tooltip:
              "A trend is rated High Confidence when multiple independent sources, across data, regulation, and market behaviour, all point in the same direction, with no significant contradictory signals.",
            align: "right",
            cardIcon: (
              <svg
                width="14"
          ...
          },
          {
            ...
            value: accelerating,
            sub: "Rapid adoption underway",
            tab: "evolution",
            tooltip:
              "Trends at the Accelerating stage show rapid growth in adoption and investment, with broadening market participation, but have not yet reached full mainstream penetration across the target industry or geography.",
            align: "right",
            cardIcon: (
              <svg
                width="14"
          ...
          >
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <div className="text-[12px] font-semibold text-slate-500 flex-1">
                {k.label}
              </div>
              <InfoTooltip
                text={k.tooltip}
            ...
            <div className="text-3xl font-black leading-none text-[#0f2644]">
              {k.value}
            </div>
      ...
      <div className="rounded-xl border border-emerald-200 bg-emerald-50/40 shadow-sm overflow-hidden">
        <div className="flex items-center gap-2 px-5 py-3.5 border-b border-emerald-100">
          ...
          <div className="text-[15px] font-bold text-[#0f2644]">
            Executive Summary
          </div>
        </div>
        <div className="flex items-center gap-5 px-5 py-5">
          <div className="flex-shrink-0 w-[110px] h-[110px] rounded-full bg-[#BAFFE4] flex items-center justify-center">
            ...
            >
              <path
                d="M48.1562 35.4818C48.1562 30.1985 43.9516 25.875 38.8134 25.875H20.125V60.463H38.9284C48.1562 60.463 48.1562 70.0728 48.1562 70.0728M48.1562 70.0728V35.4818C48.1562 30.1956 52.3609 25.875 57.4991 25.875H76.1875V60.463H57.4991C48.1562 60.463 48.1562 70.0728 48.1562 70.0728ZM53.4121 73.3125C53.997 72.0669 54.9081 71.0138 56.0431 70.2714C57.178 69.529 58.4918 69.1269 59.8369 69.1101H73.3844M42.9004 73.3125C42.3262 72.0585 41.4176 70.9979 40.2803 70.2539C39.1429 69.51 37.8236 69.1133 36.4756 69.1101H22.9281"
                stroke="#10AE5F"
                strokeWidth="3"
                strokeMiterlimit="10"
                strokeLinecap="round"
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[15px] text-black leading-relaxed">
              Between 2020 and 2030, European Industrial IoT platform
              competition is defined by five enduring structural shifts. Edge AI
              and federated architectures are mainstreaming among leading
              enterprises. Open, sovereign data ecosystems are mandated by
              binding EU regulation. AI-driven automation and digital twins are
              now baseline requirements in advanced verticals.
              Compliance-centric governance has become a market access
              prerequisite. Persistent SME and regional fragmentation remains
              the primary constraint on ecosystem-wide convergence.
            </p>
          </div>
        </div>
      </div>
          ...
          <div>
            <div className="flex items-center gap-1">
              ...
              <InfoTooltip
                ...
                intro={PRIORITY_INTRO}
                items={PRIORITY_ITEMS}
                width={300}
              />
            </div>
            <div className="text-xs text-slate-400 mt-0.5">
              Ranked by source strength & confidence, ecosystem impact, and
              strategic urgency
            </div>
          </div>
          <button
            onClick={() => onGoTab("trends")}
          ...
          {[...TRENDS]
            ...
            .map((t) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-[15px] font-semibold text-[#0f2644] truncate group-hover:text-blue-700 transition-colors">
                    {t.name}
                  </div>
                  <div
                    ...
                    <InfoTooltip
                      trigger={
                        <span className="cursor-help">
                          {fullTrendType(t.type)}
                        </span>
                      }
                      title="Trend Classifications"
                      intro={TREND_TYPE_INTRO}
                      items={TREND_TYPE_DEFINITIONS}
                      width={300}
                    />
                    <span>· {t.domain}</span>
                  </div>
                ...
                >
                  <InfoTooltip
                    trigger={
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded-md border cursor-help ${stageColor(t.stage)}`}
                      >
                        {t.stage}
                      </span>
                    }
                  ...
                  <InfoTooltip
                    trigger={
                      <span
                        className={`text-xs font-bold cursor-help ${confidenceColor(t.confidence)}`}
                      >
                        {t.confidence === "High"
                          ? "High Confidence"
                ...
                <svg
                  ...
                  strokeWidth="2"
                  viewBox="0 0 24 24"
                  className="flex-shrink-0 group-hover:stroke-blue-400 transition-colors"
                >
                  <polyline points="9 18 15 12 9 6" />
                </svg>
              </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex items-center gap-1 mb-3">
          <span className="text-[15px] font-bold text-[#0f2644]">
            Cross-Trend Convergence Patterns
          </span>
          <InfoTooltip
            title="Cross-Trend Convergence Patterns"
            text="Areas where two or more trends overlap and reinforce each other. The resulting implications only emerge when trends are read together, rather than in isolation."
          />
        </div>
...
function SignalsTab() {
  ...
  const signalSources: Record<string, SignalSource[]> = {
    "SIG-01": [
      { label: "Link 1", href: "https://aioti.eu" },
      { label: "Link 2", href: "https://ec.europa.eu" },
    ],
    "SIG-02": [
      { label: "Link 1", href: "https://eur-lex.europa.eu" },
      { label: "Link 2", href: "https://gaia-x.eu" },
    ],
    "SIG-03": [
    ...
    "SIG-04": [
      { label: "Link 1", href: "https://internationaldataspaces.org" },
      { label: "Link 2", href: "https://gaia-x.eu" },
    ],
    "SIG-05": [
      { label: "Link 1", href: "https://mckinsey.com" },
      { label: "Link 2", href: "https://ec.europa.eu/eurostat" },
    ],
  };
  ...
  const SignalCard: FC<{ sig: Signal }> = ({ sig }) => {
    ...
    return (
      <div
        className={`rounded-xl border transition-all ${isOpen ? "border-emerald-300 bg-emerald-50/40" : "border-slate-200 bg-white hover:border-slate-300 hover:shadow-sm"}`}
      >
        <div className="p-4">
          <div className="flex items-start gap-3">
            <div
              className={`w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0 ${sig.strength === "Strong" ? "bg-emerald-50" : "bg-slate-100"}`}
            >
              {sig.strength === "Strong" ? (
                <svg
                  width="12"
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-2">
                ...
                <InfoTooltip
                  trigger={
                    <span
                      className={`text-xs font-bold px-1.5 py-0.5 rounded border flex-shrink-0 cursor-help whitespace-nowrap ${sig.confidence === "High" ? "bg-emerald-50 text-emerald-700 border-emerald-200" : "bg-amber-50 text-amber-700 border-amber-200"}`}
                    >
                      {sig.confidence === "High"
                        ? "High Confidence"
                        : sig.confidence === "Moderate"
                          ? "Moderate Confidence"
                          : sig.confidence}
                    </span>
                  }
              ...
              <div className="flex items-center gap-3 mt-1.5 flex-wrap">
                <InfoTooltip
                  ...
                  intro="Each signal is classified by the primary force driving the observed shift:"
                  items={SIGNAL_CATEGORY_DEFINITIONS}
                  width={300}
                />
              ...
              <p
                className={`text-[13px] text-black mt-2 leading-relaxed ${isOpen ? "" : "line-clamp-2"}`}
              >
                {sig.description}
              </p>
            </div>
          ...
          {isOpen && (
            <div className="mt-3 pt-3 border-t border-emerald-200/70 ml-10">
              <div className="text-[13px] font-semibold text-[#0f2644] mb-1">
                Directional Implication
              </div>
              <p className="text-[13px] text-black leading-relaxed">
                {sig.directionalImplication}
              </p>
            </div>
          )}
    ...
    <div className="space-y-6">
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-1">
            ...
            <InfoTooltip
              ...
              text="Signals are discrete, observable market or technology events detected across structured research, regulatory databases, and industry publications. Each signal is assessed for strength (Strong or Weak) and its directional implication for the market."
              width={280}
            />
          </div>
          <div className="text-[15px] text-black">
            Market observations from regulatory, technology, and enterprise
            sources, classified by strength and confidence across European IIoT
            ecosystems.
          </div>
        </div>
      </div>
      <div>
        <div
          ...
          onClick={() => setStrongCollapsed((v) => !v)}
        >
          ...
          <InfoTooltip
            ...
            text="Backed by multiple independent data points with high directional confidence."
          />
          <svg
            width="18"
            height="18"
            ...
            style={{
              marginLeft: "auto",
              transition: "transform 0.2s",
              transform: strongCollapsed ? "rotate(-90deg)" : "rotate(0deg)",
            }}
          >
            <polyline points="6 9 12 15 18 9" />
          </svg>
      ...
      <div>
        ...
        >
          ...
          <InfoTooltip
            title="Weak Signals"
            text="Early-stage or single-source indicator with unresolved directional persistence."
          />
          <svg
            width="18"
            height="18"
            ...
            style={{
              marginLeft: "auto",
              transition: "transform 0.2s",
              transform: weakCollapsed ? "rotate(-90deg)" : "rotate(0deg)",
            }}
          >
            <polyline points="6 9 12 15 18 9" />
          </svg>
      ...
      <div className="rounded-xl border border-amber-100 bg-amber-50 p-4">
        <div className="flex items-center gap-1 mb-3">
          <span className="text-[15px] font-bold text-amber-800">
            Signal Gaps Identified
          </span>
          <InfoTooltip
            title="Signal Gaps Identified"
            text="Topic areas where evidence is insufficient to form a directional view."
          />
        </div>
        <ul className="space-y-2">
          {[
            ...
            <li
              key={i}
              className="text-[13px] text-amber-700 flex items-start gap-2.5"
            >
...
function TrendsTab({ onOpenDrawer }: { onOpenDrawer: (t: Trend) => void }) {
  const cardHighlights: Record<string, string[]> = {
    "TR-01": [
      "Edge AI $36.67B→$59.66B by 2032",
      "60%+ MFRs building digital twins",
      "€150M+ EU R&D funding",
    ],
    "TR-02": [
      "EU Data Act (2025) mandates openness",
      "IDSA/DSP in >60% of projects",
      "Gaia-X data spaces live",
    ],
    "TR-03": [
      ">85% firms targeting AI automation",
      "Digital twin CAGR 39.8%",
      "20–35%+ cost reduction",
    ],
    "TR-04": [
      "AI Act, CRA redefining obligations",
      "Compliance now required for market entry",
      "Gaia-X procurement rules",
    ],
    "TR-05": [
      "Germany 24.6% IIoT share",
      "SMEs <15% scale IIoT",
      "6–7M ICT skills gap by 2030",
    ],
  };
  ...
  const accentBar = (stage: string): string =>
    stage === "Mainstreaming"
      ? "#3b82f6"
      : stage === "Accelerating"
        ? "#1EDD7D"
    ...
    <div className="space-y-4">
      <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-sm flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <div className="text-[15px] text-black">
            Five structural trends shaping European IIoT platform competition
            from 2020–2030, each profiled by stage, evidence, and strategic
            implications.
          </div>
        </div>
      </div>
              ...
              <div style={{ padding: "12px 14px" }}>
                ...
                >
                  ...
                  <InfoTooltip
                    trigger={
                      <span
                        className={`font-bold px-1.5 py-0.5 rounded border cursor-help ${stageColor(t.stage)}`}
                        style={{ fontSize: 9 }}
                      >
                        {t.stage}
                      </span>
                  ...
                  <InfoTooltip
                    trigger={
                      <span
                        ...
                        className={confidenceColor(t.confidence)}
                      >
                        {t.confidence === "High"
                          ? "High Confidence"
                          : t.confidence === "Moderate"
...
const MILESTONE_DETAILS: Record<
  string,
  { year: number; label: string; detail: string }[]
> = {
  "TR-01": [
    {
      year: 2022,
      label: "Pilots scale",
      detail:
        "EU-funded edge AI pilots began scaling across industrial sites, driven by AIOTI roadmap commitments and early OPC-UA interoperability demonstrations.",
    },
    {
      year: 2025,
      label: "OPC-UA standard",
      detail:
        "OPC-UA over TSN becomes baseline architecture standard across leading European IIoT platform vendors, signalling the transition to a federated standard phase.",
    },
  ],
  "TR-02": [
    {
      ...
      label: "Data Act",
      detail:
        "EU Data Act enters into force, establishing new data-sharing obligations for connected product manufacturers and requiring open, portable data access.",
    },
    {
      year: 2027,
      label: "Harmonised",
      detail:
        "Gaia-X and IDSA data space specifications reach harmonised status across major EU member states, enabling cross-border industrial data exchange at scale.",
    },
  ],
  "TR-03": [
    {
      ...
      label: "DT baseline",
      detail:
        "Digital twin adoption exceeds 60% among large European manufacturers, with platforms integrating real-time AI inference as a default operational layer.",
    },
    {
      year: 2027,
      label: "85%+ target",
      detail:
        "Target year for 85%+ of leading enterprises to have AI-driven automation and digital twin capabilities embedded across core production systems.",
    },
  ],
  "TR-04": [
    {
      ...
      label: "AI Act live",
      detail:
        "EU AI Act enters application phase for high-risk AI systems, including industrial automation. Compliance becomes a prerequisite for new platform deployments.",
    },
    {
      year: 2025,
      label: "CRA binding",
      detail:
        "Cyber Resilience Act becomes binding, requiring all connected industrial products to meet baseline cybersecurity requirements before EU market entry.",
    },
  ],
  "TR-05": [
    {
      ...
      label: "Gap widens",
      detail:
        "Current year assessment: digital skills gap projected at 6–7M by 2030. SME IIoT adoption remains below 15%, with regional fragmentation deepening despite EU funding efforts.",
    },
    {
      year: 2028,
      label: "Review point",
      detail:
        "Key policy review window for EU digital cohesion programmes. Outcome will determine whether the SME/regional divide narrows or becomes a structural constraint on European IIoT competitiveness.",
    },
  ],
};
...
function EvolutionTab({ onOpenDrawer }: { onOpenDrawer: (t: Trend) => void }) {
  ...
  const [milestonePopup, setMilestonePopup] = useState<MilestonePopup | null>(
    null,
  );

  const phaseMap: Record<string, PhaseMapEntry[]> = {
    "TR-01": [
      { start: 2020, end: 2021, stage: "Emerging", label: "R&D / EU pilots" },
      {
        start: 2022,
        end: 2024,
        stage: "Accelerating",
        label: "Platform-wide roll-out",
      },
      {
        start: 2025,
        end: 2030,
        stage: "Mainstreaming",
        label: "Federated standard",
      },
    ],
    "TR-02": [
      { start: 2020, end: 2022, stage: "Emerging", label: "Policy formation" },
      {
        start: 2023,
        end: 2026,
        stage: "Accelerating",
        label: "Data Act / Gaia-X deploy",
      },
      {
        start: 2027,
        end: 2030,
    ...
    "TR-03": [
      {
        ...
        stage: "Accelerating",
        label: "Large-firm mainstreaming",
      },
      {
        start: 2024,
        end: 2030,
        stage: "Mainstreaming",
        label: "85%+ adoption baseline",
      },
    ],
    "TR-04": [
      {
        ...
        stage: "Emerging",
        label: "Early governance pilots",
      },
      {
        start: 2023,
        end: 2027,
        stage: "Accelerating",
        label: "AI Act / CRA enforcement",
      },
      {
        start: 2028,
        end: 2030,
        stage: "Mainstreaming",
        label: "Compliance as baseline",
      },
    ],
    "TR-05": [
      {
        ...
        stage: "Plateauing",
        label: "Persistent structural gap",
      },
    ],
  };
  ...
  const milestones: Record<string, Milestone[]> = {
    "TR-01": [
      { year: 2022, label: "Pilots scale" },
      { year: 2025, label: "OPC-UA standard" },
    ],
    "TR-02": [
      { year: 2023, label: "Data Act" },
      { year: 2027, label: "Harmonised" },
    ],
    "TR-03": [
      { year: 2024, label: "DT baseline" },
      { year: 2027, label: "85%+ target" },
    ],
    "TR-04": [
      { year: 2024, label: "AI Act live" },
      { year: 2025, label: "CRA binding" },
    ],
    "TR-05": [
      { year: 2026, label: "Gap widens" },
      { year: 2028, label: "Review point" },
    ],
  };
    ...
    <div className="space-y-6">
      <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-sm flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <div className="text-[15px] text-black">
            Longitudinal lifecycle view of all five trends from 2020–2030, with
            phase transitions, key milestones, and optimistic, conservative, and
            disruption future-state scenarios.
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white overflow-hidden shadow-sm">
        <div className="px-5 py-3.5 border-b border-slate-100 flex items-center justify-between">
          <div>
            <div className="text-[15px] font-bold text-[#0f2644]">
              Evolution Trajectory by Trend (2020–2030)
            </div>
            <div className="text-[13px] text-black mt-0.5">
              Swimlane roadmap: phases and milestones per trend
            </div>
          </div>
          <div
            ...
            {Object.entries(STAGE_PALETTE).map(([stage, c]) => {
              ...
              return (
                <div
                  key={stage}
                  className="flex items-center gap-1.5"
                  style={{ opacity: inUse ? 1 : 0.4 }}
                  title={
                    inUse
                      ? undefined
                      : "Stage not observed for any trend in this analysis"
                  }
                >
                  <div
                    className="w-2.5 h-2.5 rounded-sm border"
        ...
        <div className="p-5">
          <div className="flex mb-3">
            {[
              ...
              <div key={y} className="flex-1 text-center">
                <span
                  className={`text-xs font-semibold ${y === 2026 ? "text-orange-500 font-black" : "text-slate-400"}`}
                >
                  {y}
                </span>
                {y === 2026 && (
              ...
              return (
                <div key={trend.id}>
                  ...
                  >
                    ...
                    <div className="text-[12px] font-semibold text-[#0f2644] leading-tight group-hover:text-blue-700 transition-colors">
                      {trend.name}
                    </div>
                    <svg
                      width="11"
                  ...
                  <div className="flex w-full relative h-9">
                    {phases.map((ph, pi) => {
                      ...
                      const style =
                        phaseStyle[ph.stage] || phaseStyle["Emerging"];
                      const isFirst = pi === 0;
                      const isLast = pi === phases.length - 1;
                      return (
                        <div
                    ...
                    {marks.map((m, mi) => {
                      const xPct =
                        ((m.year - 2020 + 0.5) / (totalYears + 1)) * 100;
                      const isActive =
                        milestonePopup?.trendId === trend.id &&
                        milestonePopup?.milestoneIdx === mi;
                      return (
                        <div
                          key={mi}
                        ...
                        >
                          <div
                            className={`absolute top-0 w-3 h-3 rounded-full border-2 border-white shadow-md cursor-pointer transition-all ${isActive ? "bg-emerald-500 scale-125" : "bg-[#0f2644] hover:bg-emerald-600 hover:scale-110"}`}
                            style={{ transform: "translateY(-50%)" }}
                            title={`${m.year} · ${m.label} (click for details)`}
                          />
                        </div>
                      );
                    })}
                    ...
                    <div
                      ...
                      style={{
                        left: `${((2026 - 2020 + 0.5) / (totalYears + 1)) * 100}%`,
                        width: 0,
                        borderLeft: "1.5px dashed #f97316",
                        opacity: 0.7,
                      }}
      ...
      {milestonePopup &&
        (() => {
          const tDetails = MILESTONE_DETAILS[milestonePopup.trendId] || [];
          const mDetail = tDetails[milestonePopup.milestoneIdx];
          const trend = TRENDS.find((t) => t.id === milestonePopup.trendId);
          if (!mDetail) return null;
          return (
            <div
              className="fixed inset-0 z-50 flex items-center justify-center"
              style={{
                background: "rgba(15,38,68,0.3)",
                backdropFilter: "blur(2px)",
              }}
              onClick={() => setMilestonePopup(null)}
            >
              <div
                className="bg-white rounded-2xl shadow-2xl border border-slate-200 p-5 max-w-sm w-full mx-4"
                onClick={(e) => e.stopPropagation()}
              >
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div>
                    <div className="text-[11px] font-semibold text-slate-400 uppercase tracking-wide mb-0.5">
                      Milestone · {trend?.name}
                    </div>
                    <div className="text-[17px] font-black text-[#0f2644] leading-tight">
                      {mDetail.year} · {mDetail.label}
                    </div>
                  </div>
                  <button
                    onClick={() => setMilestonePopup(null)}
                    className="w-7 h-7 rounded-lg border border-slate-200 flex items-center justify-center flex-shrink-0 hover:bg-slate-50 transition-colors"
                  >
                    <svg
                      width="12"
                      height="12"
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="text-[15px] font-bold text-[#0f2644] mb-4">
          ...
          {[
            {
              ...
              icon: "↑",
              desc: "Operational convergence around open interoperable sovereign IIoT ecosystems. Harmonized standards mature by 2027. SME inclusion accelerates via compliance-as-a-service. EU digital sovereignty achieved across leading sectors.",
            },
            {
              label: "Conservative",
              color: "border-blue-200 bg-blue-50",
              icon: "→",
              desc: "Large-enterprise-led adoption continues while fragmentation persists among SMEs and regions. Standards converge in flagship verticals (automotive, energy). Regional divide narrows slowly. Partial sovereignty achieved.",
            },
            {
              label: "Disruption",
              color: "border-red-200 bg-red-50",
              icon: "⚡",
              desc: "Regulatory fragmentation, standards delays, or infrastructure bottlenecks slow ecosystem convergence. SME exclusion deepens. Non-EU platform providers capture market share. Sovereignty ambitions partially abandoned.",
            },
          ].map((s) => (
    ...
    if (linked.includes("–")) {
      return (
        <span className="flex items-center gap-1 flex-wrap">
          {["Trend 01", "Trend 02", "Trend 03", "Trend 04", "Trend 05"].map(
            (label, i) => {
    ...
    <div className="space-y-6">
      <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-sm flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <div className="text-[15px] text-black">
            Consolidated takeaways, emerging opportunity areas, and structural
            risks synthesised across all five trends to guide platform strategy
            through 2030.
          </div>
        </div>
      </div>
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex items-center gap-2 mb-4">
          ...
          <InfoTooltip
            title="Final Strategic Takeaways"
            text="These takeaways are ranked by strategic priority, based on synthesised cross-trend importance, evidence strength, and time-sensitivity. #1 represents the most structurally significant finding across all five trends."
          />
        </div>
        <div className="grid grid-cols-2 gap-3">
          {[
            {
              rank: 1,
              text: "European IIoT platform competition has fundamentally shifted toward architectures anchored by edge intelligence, data interoperability, and compliance orchestration, validated by regulatory alignment, market evidence, and large-scale platform evolution.",
              linked: "Trend 01, Trend 02",
            },
            {
              rank: 2,
              text: "Policy and standards-driven open/sovereign data strategies are as much a market requirement as a regulatory one; providers must design for compliance, interoperability, and sovereignty by default.",
              linked: "Trend 02, Trend 04",
            },
            {
              rank: 3,
              text: "AI-driven automation, digital twins, and predictive capabilities are converging as default layers in advanced manufacturing systems, but SME and regional inclusion remain urgent imperatives.",
              linked: "Trend 03, Trend 05",
            },
            {
              rank: 4,
              text: "Compliance, governance, and trustworthy ecosystem management have become sector-wide baselines, not premium differentiators; genuine innovation is pivoting to service design and data-centric value within trusted platforms.",
              linked: "Trend 04",
            },
            {
              rank: 5,
              text: "Persistent and potentially widening fragmentation (regional, SME, skills) poses structural risks to ecosystem resilience and pan-European industrial competitiveness; targeted policy and funding will determine the next convergence phase.",
              linked: "Trend 05",
            },
            {
              rank: 6,
              text: "Strategic focus should be on scalable federation, harmonized standards, modular interoperability, SME enablement, and supporting the synchronization of digital and green transitions within compliant, sovereign, and resilient industrial ecosystems.",
              linked: "Trend 01 – Trend 05",
            },
          ].map((t) => (
            <div
              key={t.rank}
              className="flex items-start gap-3 p-3 rounded-xl border border-slate-100 hover:border-slate-200 hover:bg-slate-50 transition-all"
            >
              <div className="w-6 h-6 rounded-full bg-[#0f2644] text-white text-xs font-black flex items-center justify-center flex-shrink-0 mt-0.5">
                {t.rank}
              </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex items-center gap-1 mb-4">
          ...
          <InfoTooltip
            title="Emerging Opportunity Areas"
            text="Market and capability white spaces identified at the intersection of two or more trends, where first-mover advantage and structural demand are both present but not yet fully served."
          />
        </div>
        <div className="grid grid-cols-2 gap-3">
          {EMERGING_OPPORTUNITIES.map((o, i) => (
            <div
              key={i}
              className="p-3.5 rounded-xl border border-emerald-200 bg-emerald-50"
            >
              <div className="text-[15px] font-semibold text-[#0f2644] mb-1">
                {o.title}
              </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex items-center gap-1 mb-4">
          ...
          <InfoTooltip
            title="Major Risks & Uncertainties"
            text="Structural risks and unresolved uncertainties that could slow, redirect, or fragment the trends identified, drawn from constraints, contradictions, and weak signals across the analysis."
          />
        </div>
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            <div
              key={i}
              className="flex items-start gap-2.5 p-3 rounded-lg bg-red-50 border border-red-100"
            >
              <svg
                width="20"
                height="20"
...
function TrendDrawer({
  ...
  const navItems: { id: string; label: string; tooltip: string }[] = [
    {
      id: "evidence",
      label: "Evidence",
      tooltip:
        "The core data points, observations, and market signals that support this trend. Also includes contradictions: signals that partially push back on the dominant trajectory.",
    },
    {
      id: "drivers",
      label: "Drivers",
      tooltip:
        "The underlying forces accelerating this trend, such as regulation, technology shifts, or market dynamics. Also includes constraints that may slow or limit its development.",
    },
    {
      id: "impact",
      label: "Impact",
      tooltip:
        "How this trend reshapes the competitive landscape, covering changes to platforms, supply chains, value creation, and the key actors most affected.",
    },
    {
      id: "implications",
      label: "Implications",
      tooltip:
        "The strategic actions and decisions this trend demands, ranked by priority and urgency for organisations operating in or adjacent to this space.",
    },
  ];

  return (
    <div
      style={{ position: "absolute", inset: 0, zIndex: 200, display: "flex" }}
    ...
    >
      ...
      >
        <div
          style={{
            height: 3,
            background: accentBar(trend.stage),
            flexShrink: 0,
          }}
        />
        ...
        >
          ...
          >
            <InfoTooltip
              trigger={
                <span
                  className={`text-xs font-bold px-2 py-0.5 rounded-lg border cursor-help ${stageColor(trend.stage)}`}
                >
                  {trend.stage}
                </span>
              }
            ...
            <InfoTooltip
              trigger={
                <span
                  className={`text-xs font-bold cursor-help ${confidenceColor(trend.confidence)}`}
                >
        ...
        >
          {navItems.map((s) => (
            ...
            >
              {s.label}
              <InfoTooltip text={s.tooltip} title={s.label} width={260} />
            </button>
          ))}
        </div>
                ...
                <>
                  ...
                  >
                    ...
                    <InfoTooltip
                      ...
                      text="Points where the evidence or narrative for this trend contains internal tensions: signals that partially conflict with or limit the dominant trajectory."
                    />
                  </div>
        ...
        >
          <button
            onClick={() => {
              if (curIdx > 0) onClose(TRENDS[curIdx - 1]);
            }}
            disabled={curIdx === 0}
            style={{
              display: "flex",
          ...
          <button
            onClick={() => {
              if (curIdx < TRENDS.length - 1) onClose(TRENDS[curIdx + 1]);
            }}
            ...
            style={{
              ...
              background: "none",
              border: "none",
              cursor: curIdx === TRENDS.length - 1 ? "not-allowed" : "pointer",
              opacity: curIdx === TRENDS.length - 1 ? 0.35 : 1,
            }}
          >
            Next
            <svg
...
export default function TrendIdentificationViewLatest() {
  ...
  return (
    <div
      className="flex flex-col h-screen bg-[#f8f9fb] overflow-hidden font-sans"
    ...
    >
      <header className="h-14 flex-shrink-0 bg-white border-b border-slate-200 flex items-center justify-between px-5 shadow-sm">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#0f2644] to-[#1a4a7a] flex items-center justify-center">
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M1 6s4-2 8 0 8 2 8 0" />
                <path d="M1 12s4-2 8 0 8 2 8 0" />
                <path d="M1 18s4-2 8 0 8 2 8 0" />
              </svg>
            </div>
            <div>
              <div className="text-base font-black text-[#0f2644] leading-none">
                CHESZ
              </div>
              <div className="text-xs font-medium text-slate-400 leading-none mt-0.5">
                Market Intelligence Platform
              </div>
            </div>
          </div>
          <span className="text-xs font-bold uppercase tracking-wide px-2 py-0.5 rounded-md bg-[#f0fdf4] border border-[#bbf7d0] text-[#15b865]">
        ...
        <div className="flex items-center gap-2">
          {["Tour", "Help"].map((l) => (
            <button
              key={l}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-slate-400 hover:text-slate-700 hover:bg-slate-50 transition-colors"
            >
              {l}
            </button>
          ))}
          <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#0f2644] to-[#1a4a7a] flex items-center justify-center text-xs font-extrabold text-white">
            NT
          </div>
        </div>
      </header>
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="w-[210px] flex-shrink-0 bg-white border-r border-slate-200 flex flex-col z-10 overflow-y-auto">
          <nav className="flex-1 p-2.5 flex flex-col gap-0.5">
            ...
            {SB_SEC.map((item, i) => (
              <button
                key={i}
                className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-medium text-slate-400 w-full text-left border-l-[3px] border-transparent hover:bg-slate-50 hover:text-slate-700 transition-all"
              >
          ...
          <div className="p-3 border-t border-slate-200 flex-shrink-0">
            <div className="rounded-xl p-3 border-[1.5px] border-slate-200 bg-[#f4f6f9]">
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <span className="text-base font-bold text-[#0f2644]">
                  Credits
                </span>
              </div>
        ...
        <div className="flex flex-col flex-1 overflow-hidden min-w-0">
          <div className="flex-shrink-0 bg-white border-b border-slate-200 px-6 py-3.5 flex items-center justify-between gap-4 shadow-sm">
            <div className="min-w-0">
              <div className="text-[15px] font-bold text-[#0f2644] truncate">
                Trend identification for European Industrial IoT Platforms
              </div>
            </div>
            <div className="flex items-center gap-2 flex-shrink-0">
              {[
                ...
                <button
                  key={btn.label}
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg border border-slate-200 bg-white text-xs font-semibold text-blue-600 hover:border-blue-300 hover:bg-blue-50 transition-colors"
                >
                  {btn.icon}
                  {btn.label}
                </button>
          ...
          <nav className="flex-shrink-0 bg-white border-b border-slate-200 px-6 flex shadow-sm">
            {NAV_TABS.map((t) => (
              ...
              >
                ...
                {t.badge && (
                  <span
                    className={`text-[13px] font-black px-1.5 py-0.5 rounded-full ml-0.5 ${tab === t.id ? "bg-[#1EDD7D] text-[#0f2644]" : "bg-slate-100 text-black"}`}
                  >
                    {t.badge}
                  </span>
                )}
          ...
          <main className="flex-1 overflow-y-auto px-6 py-6">
            {tab === "overview" && (
              <OverviewTab onGoTab={setTab} onOpenDrawer={setDrawerTrend} />
            )}
            {tab === "signals" && <SignalsTab />}
            {tab === "trends" && <TrendsTab onOpenDrawer={setDrawerTrend} />}
            {tab === "evolution" && (
              <EvolutionTab onOpenDrawer={setDrawerTrend} />
            )}
            {tab === "synthesis" && (
              <SynthesisTab
                onOpenDrawer={(t) => {
      ...
      {drawerTrend && (
        <TrendDrawer
          trend={drawerTrend}
          onClose={(next) =>
            next && next.id ? setDrawerTrend(next) : setDrawerTrend(null)
          }
        />
      )}
    </div>
